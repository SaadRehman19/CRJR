...
const TrustedByCard = () => {
  return (
    <div className="absolute bottom-[32px] left-[32px] bg-white rounded-[12px] shadow-[0px_4px_8px_0px_rgba(0,0,0,0.1)] h-[72.74px] w-[264.51px] flex items-center px-[18.74px] gap-3 z-10">
      ...
      <div className="flex-1">
        <p className="text-[13.225px] leading-[17.634px] text-[#475569] font-normal">Trusted by top</p>
        <p className="text-[13.225px] leading-[17.634px] text-[#475569] font-normal">brands</p>
      </div>
    </div>
  );
};
